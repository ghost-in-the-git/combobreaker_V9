        ...
        dialogue: [
            {
                ...
                response: "'Not that simple.' She leans on the counter. 'You're an autonomous rig. No heartbeat in the cockpit. That makes people nervous.' She glances at the room — pilots hunched over drinks, a few playing cards in the back, one asleep with his head on the bar. 'Even the drunk ones have standards. They won't sync with a frame that hasn't proven it can keep them alive.' She pulls out a mission dossier and sets it on the bar. 'You want a pilot? Do the work first. Each tier has a job attached — clear it, and those pilots know you're worth strapping into.' She taps the logbook. 'Once you've got the clearance, I'll make the introductions. They jack into your neural sync rig, your frame gets the benefit of a real pilot's reflexes. Better sync, better stats across the board.' She takes the book back. 'You're not buying loyalty. You're renting a nervous system. But first you earn the right to rent it.'"
            },
            {
